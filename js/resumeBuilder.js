      ...
      jobs: [
        {
          ...
          description:
            '● Developed   Employee   and   Visitor   tracking   web   app.   This   app   track   and   manages   the   employees  a nd   visitors.<br>  ● Closely   worked   with   back-end   developers   to   opmize   exisng   Web   technology   and   implemented   an   Indoor  posioning   system   using   the   trilateraon   concept.<br>  ● Priorized   and   managed   mulple   tasks   across   mulple   projects,   under   ght   deadlines.<br>  ● Made   the   app   secure   using   environment   variable   and   improved   the   performance   by   making   constants   and  removing   redundant   code.   Converted   PSD’s   to   standard-compliant   HTML   and   CSS.<br>  ● Monitored   Student   tracking   web   app   and   mobile   app   performance   and   recﬁed   front-end-related   issues.<br>  ● Technologies   Used:   ReactJS,   React   Nave,   JavaScript,   Material   UI,   Trilateraon   (for   indoor   posioning).'
        }
      ]
    },
